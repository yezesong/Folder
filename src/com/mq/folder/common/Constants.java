...
public class Constants {
    ...
    public final static String DEFAULT_CHANNL = "cxyxq0918";
    ...
    public static final String ACTION_PROGRESS = "com.mq.folder.progress.update";


	public static final String [] APPS = {"com.kugou.android"};
